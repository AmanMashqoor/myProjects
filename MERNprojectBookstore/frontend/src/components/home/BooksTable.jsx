                                ...
                                <td className="border border-slate-700 rounded-md text-center">
                                    <div className="flex justify-center gap-x-4">
                                        ...
                                        <Link to={`/books/edit/${book._id}`}>
                                            <AiOutlineEdit className="text-2x1 text-yellow-800 hover:text-black cursor-pointer"/>
                                        </Link>
                                        <Link to={`/books/delete/${book._id}`}>
                                            <MdOutlineDelete className="text-2x1 text-red-600 hover:text-black cursor-pointer"/>
                                        </Link>
                                    </div>
                                </td>
                            </tr>
