        ...
        <div className="flex-overflow">
            <div className="flex bg-gray-400 w-screen justify-center">
                <div className="flex flex-col">
                    ...
                    {
                        signup ? <p>New User? Go to <Link to='/signup' className="text-blue-800"><u>Sign Up</u></Link></p> : <p>Already have an account?<br></br> Go to <Link to='/login' className="text-blue-800"><u>Log In</u></Link></p>
                    }    
                    </h2>
                    <form action="" className="flex flex-col">
                    <input className="justify-center p-2 m-2" type="text" placeholder="Name" required/>
